...
Since this descriptor may be in a different unit, in general access must proceed along the usual <a href="/docs/api/namespaces/llvm/arm">ARM</a> rules. A common sequence to produce is: 
