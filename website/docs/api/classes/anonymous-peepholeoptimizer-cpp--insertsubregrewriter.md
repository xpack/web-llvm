...
slug: /api/classes/anonymous-peepholeoptimizer-cpp-/insertsubregrewriter
...
# `InsertSubregRewriter` Class

<p>Specialized rewriter for INSERT_SUBREG instruction. <a href="#details">More...</a></p>

## Declaration

<div class="doxyDeclaration">
class anonymous{PeepholeOptimizer.cpp}::InsertSubregRewriter { ... }
</div>
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#a8d792ce793510d7ac2ad168873579747">InsertSubregRewriter</a> (MachineInstr &amp;MI)</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#aae0a3466d999e3c2435e10e766335499">getNextRewritableSource</a> (RegSubRegPair &amp;Src, RegSubRegPair &amp;Dst) override</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<tr class="doxyMemberIndexItem">
<td class="doxyMemberIndexItemType" align="left" valign="top">bool</td>
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#a448ffa9de937932dddc4d927c1554aab">RewriteCurrentSource</a> (Register NewReg, unsigned NewSubReg) override</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
<p>Rewrite the current source with <span class="doxyComputerOutput">NewReg</span> and <span class="doxyComputerOutput">NewSubReg</span> if possible. <a href="#a448ffa9de937932dddc4d927c1554aab">More...</a></p>
</td>
</tr>
<tr class="doxyMemberIndexSeparator">
<td class="doxyMemberIndexSeparator" colspan="2"></td>
...
<p>Specialized rewriter for INSERT_SUBREG instruction.</p>

<p>Definition at line 270 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/peepholeoptimizer-cpp">PeepholeOptimizer.cpp</a>.</p>
...
<tr>
<td class="doxyMemberName">anonymous{PeepholeOptimizer.cpp}::InsertSubregRewriter::InsertSubregRewriter (<a href="/web-llvm/docs/api/classes/llvm/machineinstr">MachineInstr</a> &amp; MI)</td>
</tr>
</table>
</td>
...
<p>Definition at line 272 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/peepholeoptimizer-cpp">PeepholeOptimizer.cpp</a>.</p>
...
<dt>See Also</dt>
<dd><p>See <a href="/web-llvm/docs/api/classes/anonymous-peepholeoptimizer-cpp-/rewriter/#a3fa829354b3f8b782d40175469540cab">Rewriter::getNextRewritableSource()</a> Here <a href="/web-llvm/docs/api/classes/anonymous-peepholeoptimizer-cpp-/rewriter/#a1ab74e93e550820b697e99a0dc9fdbbd">CopyLike</a> has the following form: dst = INSERT_SUBREG Src1, Src2.src2SubIdx, subIdx. Src1 has the same register class has dst, hence, there is nothing to rewrite. Src2.src2SubIdx, may not be register <a href="/web-llvm/docs/api/files/lib/lib/codegen/registercoalescer-cpp/#a431319a3132451944eb1d97c9514e476">coalescer</a> friendly. Therefore, the first call to this method returns: (SrcReg, SrcSubReg) = (Src2, src2SubIdx). (DstReg, DstSubReg) = (dst, subIdx).</p></dd>
</dl>


<p>Subsequence calls will return false.</p>


<p>Definition at line 287 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/peepholeoptimizer-cpp">PeepholeOptimizer.cpp</a>.</p>
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">bool anonymous{PeepholeOptimizer.cpp}::InsertSubregRewriter::RewriteCurrentSource (<a href="/web-llvm/docs/api/classes/llvm/register">Register</a> NewReg, unsigned NewSubReg)</td>
</tr>
</table>
</td>
<td class="doxyMemberLabelsRight">
...
<p>Definition at line 308 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/peepholeoptimizer-cpp">PeepholeOptimizer.cpp</a>.</p>
