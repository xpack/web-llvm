...
<CodeLine><span class="doxyHighlight">%s1 = shufflevector &lt;2 x ty&gt; %0, poison, &lt;1, 0&gt;</span></CodeLine>
<CodeLine><span class="doxyHighlight">%s2 = shufflevector &lt;2 x ty&gt; %1, poison, &lt;1, 0&gt;</span></CodeLine>

</ProgramListing>
 and if need to emit shuffle of s1 and s2 with mask &lt;1, 0, 3, 2&gt;, it will look through s1 and s2 and emit 
<ProgramListing>

<CodeLine><span class="doxyHighlight">%res = shufflevector &lt;2 x ty&gt; %0, %1, &lt;0, 1, 2, 3&gt;</span></CodeLine>
...
<CodeLine><span class="doxyHighlight">%s1 = shufflevector &lt;2 x ty&gt; %0, poison, &lt;1, 0, 1, 0&gt;</span></CodeLine>
<CodeLine><span class="doxyHighlight">%s2 = shufflevector &lt;2 x ty&gt; %1, poison, &lt;1, 0, 1, 0&gt;</span></CodeLine>
...
<MemberDefinition
  prototype={<>void llvm::slpvectorizer::BoUpSLP::ShuffleInstructionBuilder::add (<a href="/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64promoteconstant-cpp/#a90f8350fecae261c25be85d38b451bff">const</a> TreeEntry &amp; NaN, <a href="/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64promoteconstant-cpp/#a90f8350fecae261c25be85d38b451bff">const</a> TreeEntry &amp; NaN, <a href="/docs/api/classes/llvm/arrayref">ArrayRef</a>&lt; int &gt; Mask)</>}
  labels = {["inline"]}>
...
<MemberDefinition
  prototype={<>void llvm::slpvectorizer::BoUpSLP::ShuffleInstructionBuilder::add (<a href="/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64promoteconstant-cpp/#a90f8350fecae261c25be85d38b451bff">const</a> TreeEntry &amp; NaN, <a href="/docs/api/classes/llvm/arrayref">ArrayRef</a>&lt; int &gt; Mask)</>}
  labels = {["inline"]}>
