...
<CodeLine><span class="doxyHighlight">std::string <a href="/docs/api/namespaces/llvm/pdb/#ac10322dc19a928c2dbb83ec9689dc23caac70412e939d72a9234cdebb1af5867b">Path</a> = </span><span class="doxyHighlightStringLiteral">&quot;/path/to/socket&quot;</span></CodeLine>
<CodeLine><span class="doxyHighlight">Expected&lt;ListeningSocket&gt; S = <a href="#a22cd57e089541409aa05153237a44729">ListeningSocket::createUnix</a>(Path);</span></CodeLine>
<CodeLine></CodeLine>
<CodeLine><span class="doxyHighlightKeywordFlow">if</span><span class="doxyHighlight"> (S) &#123;</span></CodeLine>
<CodeLine><span class="doxyHighlight">  Expected&lt;std::unique&#95;ptr&lt;raw&#95;socket&#95;stream&gt;&gt; connection = S-&gt;accept();</span></CodeLine>
<CodeLine><span class="doxyHighlight">  </span><span class="doxyHighlightKeywordFlow">if</span><span class="doxyHighlight"> (connection) &#123;</span></CodeLine>
<CodeLine><span class="doxyHighlight">    </span><span class="doxyHighlightComment">// Use the accepted raw&#95;socket&#95;stream for communication.</span></CodeLine>
