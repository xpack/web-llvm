...
However, the specified instruction has multiple uses. Given this, it may actually increase register pressure to fold it into the load. For example, consider this code: 
