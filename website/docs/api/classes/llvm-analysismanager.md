...
<p>Walk through all of the analyses pertaining to this unit of IR and invalidate them, unless they are preserved by the <a href="/web-llvm/docs/api/classes/llvm/preservedanalyses">PreservedAnalyses</a> set.</p>
