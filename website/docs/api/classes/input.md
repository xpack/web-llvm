...
<p>The <a href="/web-llvm/docs/api/classes/input">Input</a> class is used to parse a yaml document into in-memory structs and vectors. <a href="#details">More...</a></p>
...
<tr class="doxyMemberIndexItem">
<td class="doxyMemberIndexItemType" align="left" valign="top">document_iterator</td>
...
<p>The <a href="/web-llvm/docs/api/classes/input">Input</a> class is used to parse a yaml document into in-memory structs and vectors.</p>


<p>It works by using YAMLParser to do a syntax parse of the entire yaml document, then the <a href="/web-llvm/docs/api/classes/input">Input</a> class builds a graph of HNodes which wraps each yaml <a href="/web-llvm/docs/api/classes/node">Node</a>. The extra layer is buffering. The low level yaml parser only lets you look at each node once. The buffering layer lets you search and interate multiple times. This is necessary because the <a href="/web-llvm/docs/api/classes/llvm/yaml/io/#a76b59883a4b23c1cb5c5f55eac119f0d">mapRequired()</a> method calls may not be in the same order as the keys in the document.</p>
