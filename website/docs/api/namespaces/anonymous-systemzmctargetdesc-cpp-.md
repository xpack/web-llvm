...
slug: /api/namespaces/anonymous-systemzmctargetdesc-cpp-
...
# The `anonymous{SystemZMCTargetDesc.cpp}` Namespace Reference
...
namespace anonymous{SystemZMCTargetDesc.cpp} { ... }
</div>
