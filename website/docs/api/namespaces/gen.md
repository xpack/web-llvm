...
<p>-inline-oz-test-model</p>


<p>-regalloc-priority-test-model</p>


<p>-regalloc-eviction-test-model</p>



<pre><code>Generate a mock model for LLVM tests.
...
<pre><code>Generate a mock model for LLVM tests for Register Allocation.
The generated model is not a neural net - it is just a tf.function with the
correct input and output parameters. By construction, the mock model will always
