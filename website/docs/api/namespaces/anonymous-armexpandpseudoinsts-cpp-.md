...
slug: /api/namespaces/anonymous-armexpandpseudoinsts-cpp-
...
# The `anonymous{ARMExpandPseudoInsts.cpp}` Namespace Reference
...
namespace anonymous{ARMExpandPseudoInsts.cpp} { ... }
</div>
