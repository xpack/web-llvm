...
slug: /api/namespaces/anonymous-globalmergefunctions-cpp-
...
# The `anonymous{GlobalMergeFunctions.cpp}` Namespace Reference
...
namespace anonymous{GlobalMergeFunctions.cpp} { ... }
</div>
