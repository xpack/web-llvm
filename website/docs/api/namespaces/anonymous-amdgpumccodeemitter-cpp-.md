...
slug: /api/namespaces/anonymous-amdgpumccodeemitter-cpp-
...
# The `anonymous{AMDGPUMCCodeEmitter.cpp}` Namespace Reference
...
namespace anonymous{AMDGPUMCCodeEmitter.cpp} { ... }
</div>
