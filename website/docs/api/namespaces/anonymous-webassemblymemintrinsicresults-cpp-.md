...
slug: /api/namespaces/anonymous-webassemblymemintrinsicresults-cpp-
...
# The `anonymous{WebAssemblyMemIntrinsicResults.cpp}` Namespace Reference
...
namespace anonymous{WebAssemblyMemIntrinsicResults.cpp} { ... }
</div>
