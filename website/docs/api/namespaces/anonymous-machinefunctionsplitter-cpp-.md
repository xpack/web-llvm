...
slug: /api/namespaces/anonymous-machinefunctionsplitter-cpp-
...
# The `anonymous{MachineFunctionSplitter.cpp}` Namespace Reference
...
namespace anonymous{MachineFunctionSplitter.cpp} { ... }
</div>
