...
slug: /api/namespaces/anonymous-hexagonisellowering-cpp-
...
# The `anonymous{HexagonISelLowering.cpp}` Namespace Reference
...
namespace anonymous{HexagonISelLowering.cpp} { ... }
</div>
