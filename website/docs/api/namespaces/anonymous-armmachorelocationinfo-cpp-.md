...
slug: /api/namespaces/anonymous-armmachorelocationinfo-cpp-
...
# The `anonymous{ARMMachORelocationInfo.cpp}` Namespace Reference
...
namespace anonymous{ARMMachORelocationInfo.cpp} { ... }
</div>
