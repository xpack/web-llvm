...
slug: /api/namespaces/anonymous-epcindirectionutils-cpp-
...
# The `anonymous{EPCIndirectionUtils.cpp}` Namespace Reference
...
namespace anonymous{EPCIndirectionUtils.cpp} { ... }
</div>
