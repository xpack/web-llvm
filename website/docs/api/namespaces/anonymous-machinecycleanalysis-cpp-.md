...
slug: /api/namespaces/anonymous-machinecycleanalysis-cpp-
...
# The `anonymous{MachineCycleAnalysis.cpp}` Namespace Reference
...
namespace anonymous{MachineCycleAnalysis.cpp} { ... }
</div>
