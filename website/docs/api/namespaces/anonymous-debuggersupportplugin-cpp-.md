...
slug: /api/namespaces/anonymous-debuggersupportplugin-cpp-
...
# The `anonymous{DebuggerSupportPlugin.cpp}` Namespace Reference
...
namespace anonymous{DebuggerSupportPlugin.cpp} { ... }
</div>
