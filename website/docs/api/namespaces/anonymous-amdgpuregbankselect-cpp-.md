...
slug: /api/namespaces/anonymous-amdgpuregbankselect-cpp-
...
# The `anonymous{AMDGPURegBankSelect.cpp}` Namespace Reference
...
namespace anonymous{AMDGPURegBankSelect.cpp} { ... }
</div>
