...
slug: /api/namespaces/anonymous-ppcelfobjectwriter-cpp-
...
# The `anonymous{PPCELFObjectWriter.cpp}` Namespace Reference
...
namespace anonymous{PPCELFObjectWriter.cpp} { ... }
</div>
