...
slug: /api/namespaces/anonymous-scalarevolutionnormalization-cpp-
...
# The `anonymous{ScalarEvolutionNormalization.cpp}` Namespace Reference
...
namespace anonymous{ScalarEvolutionNormalization.cpp} { ... }
</div>
