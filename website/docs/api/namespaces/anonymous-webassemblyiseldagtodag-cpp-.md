...
namespace anonymous{WebAssemblyISelDAGToDAG.cpp} { ... }
</div>
...
<p>WebAssembly-specific code to select <a href="/web-llvm/docs/api/namespaces/llvm/webassembly">WebAssembly</a> machine instructions for <a href="/web-llvm/docs/api/classes/llvm/selectiondag">SelectionDAG</a> operations.</p>
