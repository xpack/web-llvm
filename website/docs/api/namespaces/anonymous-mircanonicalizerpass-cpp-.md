...
slug: /api/namespaces/anonymous-mircanonicalizerpass-cpp-
...
# The `anonymous{MIRCanonicalizerPass.cpp}` Namespace Reference
...
namespace anonymous{MIRCanonicalizerPass.cpp} { ... }
</div>
