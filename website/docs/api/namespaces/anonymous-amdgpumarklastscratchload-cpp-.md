...
slug: /api/namespaces/anonymous-amdgpumarklastscratchload-cpp-
...
# The `anonymous{AMDGPUMarkLastScratchLoad.cpp}` Namespace Reference
...
namespace anonymous{AMDGPUMarkLastScratchLoad.cpp} { ... }
</div>
