...
slug: /api/namespaces/anonymous-mipswincoffobjectwriter-cpp-
...
# The `anonymous{MipsWinCOFFObjectWriter.cpp}` Namespace Reference
...
namespace anonymous{MipsWinCOFFObjectWriter.cpp} { ... }
</div>
