...
slug: /api/namespaces/anonymous-coveragemappingwriter-cpp-
...
# The `anonymous{CoverageMappingWriter.cpp}` Namespace Reference
...
namespace anonymous{CoverageMappingWriter.cpp} { ... }
</div>
