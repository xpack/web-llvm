...
slug: /api/namespaces/anonymous-amdgpuregisterbankinfo-cpp-
...
# The `anonymous{AMDGPURegisterBankInfo.cpp}` Namespace Reference
...
namespace anonymous{AMDGPURegisterBankInfo.cpp} { ... }
</div>
