...
slug: /api/namespaces/anonymous-systemzelfobjectwriter-cpp-
...
# The `anonymous{SystemZELFObjectWriter.cpp}` Namespace Reference
...
namespace anonymous{SystemZELFObjectWriter.cpp} { ... }
</div>
