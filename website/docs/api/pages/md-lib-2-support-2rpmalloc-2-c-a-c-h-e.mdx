...
slug: /api/pages/md-lib-2-support-2rpmalloc-2-c-a-c-h-e
...
The benchmark is configured to run threads allocating 150000 blocks distributed in the <code>&#91;16, 16000&#93;</code> bytes range with a linear falloff probability. It runs 1000 loops, and every iteration 75000 blocks (50%) are freed and allocated in a scattered pattern. There are no cross thread allocations/deallocations. Parameters: <code>benchmark n 0 0 0 1000 150000 75000 16 16000</code>. The benchmarks are run on an Ubuntu 16.10 machine with 8 cores (4 physical, HT) and 12GiB RAM.
...
<figure>  <img src="https://docs.google.com/spreadsheets/d/1NWNuar1z0uPCB5iVS_Cs6hSo2xPkTmZf0KsgWS_Fb_4/pubchart?oid=387883204&format=image" alt="Ubuntu 16.10 random [16, 16000] bytes, 8 cores" class="inline" />
</figure>
 
<figure>  <img src="https://docs.google.com/spreadsheets/d/1NWNuar1z0uPCB5iVS_Cs6hSo2xPkTmZf0KsgWS_Fb_4/pubchart?oid=1644710241&format=image" alt="Ubuntu 16.10 random [16, 16000] bytes, 8 cores" class="inline" />
</figure>
