...
<div class="doxyIncludesList">#include "<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/amdgpu/r600asmprinter-h">R600AsmPrinter.h</a>"
...
<p>The <a href="/web-llvm/docs/api/classes/llvm/r600asmprinter">R600AsmPrinter</a> is used to print both assembly string and also binary code.</p>
