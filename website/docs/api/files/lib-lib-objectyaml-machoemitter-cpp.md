...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/namespaces/anonymous-machoemitter-cpp-">anonymous{MachOEmitter.cpp}</a></td>
</tr>
...
<p>The Mach component of yaml2obj.</p>
...
<div class="doxyVerbatim">  case MachO::LCName:                                                          \
    <a href="/web-llvm/docs/api/files/lib/lib/passes/passbuilderbindings-cpp/#acdfbcf188e2d4a80837e89de2ccdffab">if</a> (Obj.IsLittleEndian != sys::IsLittleEndianHost)                         \
      MachO::swapStruct(Data.LCStruct##_data);                                 \
    <a href="/web-llvm/docs/api/files/lib/lib/executionengine/lib/executionengine/runtimedyld/runtimedyldelf-cpp/#a79ab15165c16fbf94d6fd33bd890ea7e">OS.write</a>(reinterpret_cast&lt;<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64promoteconstant-cpp/#a90f8350fecae261c25be85d38b451bff">const</a> char *&gt;(&amp;(Data.LCStruct##_data)),          \
...
<p>Definition at line 251 of file <a href="/web-llvm/docs/api/files/lib/lib/objectyaml/machoemitter-cpp">MachOEmitter.cpp</a>.</p>
