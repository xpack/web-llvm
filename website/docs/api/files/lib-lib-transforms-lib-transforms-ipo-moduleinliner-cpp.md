...
#include "<a href="/web-llvm/docs/api/files/include/include/llvm/include/llvm/analysis/inlineorder-h">llvm/Analysis/InlineOrder.h</a>"
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#a6e6ccf80a7fe29b98a4cad16d4a4fc59">CtxProfPromoteAlwaysInline</a>("ctx-prof-promote-alwaysinline", cl::init(false), cl::Hidden, cl::desc("If using a contextual profile in this module, and an indirect " "call target is marked as alwaysinline, perform indirect call " "promotion for that target. If multiple targets for an indirect " "call site fit this description, they are all promoted."))</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#ad78e062f62e0d6e453941fb4ca843e4d">DEBUG_TYPE</a>&nbsp;&nbsp;&nbsp;"module-inline"</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<p>Definition at line 61 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
...
<p>Definition at line 101 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
...
<p>Definition at line 49 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
...
<p>Definition at line 50 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">cl::opt&lt; bool &gt; CtxProfPromoteAlwaysInline("ctx-prof-promote-alwaysinline", cl::init(false), cl::Hidden, cl::desc("If using a contextual profile in this module, and an indirect " "call target is marked as alwaysinline, perform indirect call " "promotion for that target. If multiple targets for an indirect " "call site fit this description, they are all promoted."))</td>
</tr>
</table>
</td>
</tr>
...
<p>Definition at line 52 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">#define DEBUG_TYPE&nbsp;&nbsp;&nbsp;"module-inline"</td>
</tr>
</table>
</td>
</tr>
...
<p>Definition at line 47 of file <a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/ipo/moduleinliner-cpp">ModuleInliner.cpp</a>.</p>
