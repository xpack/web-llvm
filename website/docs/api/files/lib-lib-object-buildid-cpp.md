...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/namespaces/anonymous-buildid-cpp-">anonymous{BuildID.cpp}</a></td>
</tr>
...
<p>This file defines a library for handling Build IDs and using them to find debug info.</p>
