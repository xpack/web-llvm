...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/structs/llvm/incoming">Incoming</a></td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
<p><a href="/web-llvm/docs/api/structs/llvm/incoming">Incoming</a> for lane maks phi as machine instruction, incoming register <span class="doxyComputerOutput">Reg</span> and incoming block <span class="doxyComputerOutput">Block</span> are taken from machine instruction. <a href="/web-llvm/docs/api/structs/llvm/incoming/#details">More...</a></p>
</td>
</tr>
<tr class="doxyMemberIndexSeparator">
<td class="doxyMemberIndexSeparator" colspan="2"></td>
...
<p>Interface definition of the PhiLoweringHelper class that implements lane mask merging algorithm for divergent i1 phis.</p>
