...
#include "<a href="/web-llvm/docs/api/files/include/include/llvm/include/llvm/mca/custombehaviour-h">llvm/MCA/CustomBehaviour.h</a>"
...
<p>This file defines the AMDGPUCustomBehaviour class which inherits from CustomBehaviour.</p>


<p>This class is used by the tool llvm-mca to enforce target specific behaviour that is not expressed well enough in the scheduling model for mca to enforce it automatically.</p>
