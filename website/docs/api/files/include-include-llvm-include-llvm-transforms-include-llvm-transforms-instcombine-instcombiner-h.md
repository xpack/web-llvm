...
<p>This file provides the interface for the instcombine pass implementation. <a href="#details">More...</a></p>
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/classes/llvm/instcombiner">InstCombiner</a></td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
<p>The core instruction combiner logic. <a href="/web-llvm/docs/api/classes/llvm/instcombiner/#details">More...</a></p>
</td>
</tr>
<tr class="doxyMemberIndexSeparator">
<td class="doxyMemberIndexSeparator" colspan="2"></td>
...
<p>This file provides the interface for the instcombine pass implementation.</p>


<p>The interface is used for generic transformations in this folder and target specific combinations in the targets. The visitor implementation is in <span class="doxyComputerOutput">InstCombinerImpl</span> in <span class="doxyComputerOutput"><a href="/web-llvm/docs/api/files/lib/lib/transforms/lib/transforms/instcombine/instcombineinternal-h">InstCombineInternal.h</a></span>.</p>
...
<p>Definition at line 32 of file <a href="/web-llvm/docs/api/files/include/include/llvm/include/llvm/transforms/include/llvm/transforms/instcombine/instcombiner-h">InstCombiner.h</a>.</p>
