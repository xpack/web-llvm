...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/structs/llvm/liverangecalc/liveinblock">LiveInBlock</a></td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
<p>LiveInBlock - Information about a basic block where a live range is known to be live-in, but the value has not yet been determined. <a href="/web-llvm/docs/api/structs/llvm/liverangecalc/liveinblock/#details">More...</a></p>
</td>
</tr>
<tr class="doxyMemberIndexSeparator">
<td class="doxyMemberIndexSeparator" colspan="2"></td>
