...
# `PPCTargetTransformInfo.h` File

<p>This file a TargetTransformInfo::Concept conforming object specific to the PPC target machine. <a href="#details">More...</a></p>
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/classes/llvm/ppcttiimpl">PPCTTIImpl</a></td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<p>This file a TargetTransformInfo::Concept conforming object specific to the PPC target machine.</p>
