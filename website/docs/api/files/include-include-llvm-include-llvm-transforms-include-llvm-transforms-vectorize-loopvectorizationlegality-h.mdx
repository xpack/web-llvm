...
This holds details about a histogram operation – a load -&gt; update -&gt; store sequence where each lane in a vector might be updating the same element as another lane. <a href="/docs/api/structs/llvm/histograminfo/#details">More...</a>
</MembersIndexItem>
