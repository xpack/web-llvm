...
<p>A utility class used to compute instruction encodings.</p>


<p>It buffers encodings for later usage. It exposes a simple API to compute and get the encodings as StringRef.</p>
