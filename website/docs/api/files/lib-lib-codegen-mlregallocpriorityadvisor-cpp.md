...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#ac3475af8b559fd11abe8b90cd2055d16">InteractiveChannelBaseName</a>("regalloc-priority-interactive-channel-base", cl::Hidden, cl::desc("Base file path for the interactive mode. The incoming filename should " "have the name <regalloc-priority-interactive-channel-base>.in, while " "the outgoing name should be " "<regalloc-priority-interactive-channel-base>.out"))</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#aec4a667db91c6ba36aacd2e4d03511e7">RA_PRIORITY_FEATURES_LIST</a>(M)&nbsp;&nbsp;&nbsp;...</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<tr class="doxyMemberIndexItem">
<td class="doxyMemberIndexItemType" align="left" valign="top">#define</td>
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#af5e2460c58b78f9becd283f9f0dc70ee">DecisionName</a>&nbsp;&nbsp;&nbsp;"priority"</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<tr class="doxyMemberIndexItem">
<td class="doxyMemberIndexItemType" align="left" valign="top">#define</td>
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#a31d7c26a433d132cca4ea4faa86e0869">_FEATURE_IDX</a>(_, name, __, ___)&nbsp;&nbsp;&nbsp;<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/aarch64/smeabipass-cpp/#a8f8f80d37794cde9472343e4487ba3eb">name</a>,</td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<tr>
<td class="doxyMemberName">cl::opt&lt; std::string &gt; InteractiveChannelBaseName("regalloc-priority-interactive-channel-base", cl::Hidden, cl::desc( "Base file path for the interactive mode. The incoming filename should " "have the name &lt;regalloc-priority-interactive-channel-base&gt;.in, while " "the outgoing name should be " "&lt;regalloc-priority-interactive-channel-base&gt;.out"))</td>
</tr>
</table>
</td>
...
<p>Definition at line 45 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/mlregallocpriorityadvisor-cpp">MLRegAllocPriorityAdvisor.cpp</a>.</p>
...
<p>Definition at line 113 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/mlregallocpriorityadvisor-cpp">MLRegAllocPriorityAdvisor.cpp</a>.</p>

</div>
</div>

### \_FEATURE\_IDX {#a31d7c26a433d132cca4ea4faa86e0869}
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">#define _FEATURE_IDX(_, name, __, ___)&nbsp;&nbsp;&nbsp;<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/aarch64/smeabipass-cpp/#a8f8f80d37794cde9472343e4487ba3eb">name</a>,</td>
</tr>
</table>
</td>
</tr>
...
<p>Definition at line 86 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/mlregallocpriorityadvisor-cpp">MLRegAllocPriorityAdvisor.cpp</a>.</p>
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">#define DecisionName&nbsp;&nbsp;&nbsp;"priority"</td>
</tr>
</table>
</td>
</tr>
...
<p>Definition at line 79 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/mlregallocpriorityadvisor-cpp">MLRegAllocPriorityAdvisor.cpp</a>.</p>

</div>
</div>

### RA\_PRIORITY\_FEATURES\_LIST {#aec4a667db91c6ba36aacd2e4d03511e7}
...
<table class="doxyMemberName">
<tr>
<td class="doxyMemberName">#define RA_PRIORITY_FEATURES_LIST(M)&nbsp;&nbsp;&nbsp;...</td>
</tr>
</table>
</td>
</tr>
...
<dt>Value</dt>
<dd>
<div class="doxyVerbatim">  M(int64_t, li_size, PerLiveRangeShape, "size")                               \
...
<p>Definition at line 74 of file <a href="/web-llvm/docs/api/files/lib/lib/codegen/mlregallocpriorityadvisor-cpp">MLRegAllocPriorityAdvisor.cpp</a>.</p>
