...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/classes/llvm/genericssacontext">GenericSSAContext&lt;_FunctionT&gt;</a></td>
</tr>
<tr class="doxyMemberIndexDescription">
<td class="doxyMemberIndexDescriptionLeft"></td>
<td class="doxyMemberIndexDescriptionRight">
...
<p>This file defines the little GenericSSAContext&lt;X&gt; template class that can be used to implement IR analyses as templates.</p>


<p>Specializing these templates allows the analyses to be used over both LLVM IR and Machine IR.</p>
