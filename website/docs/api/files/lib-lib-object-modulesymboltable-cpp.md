...
#include "<a href="/web-llvm/docs/api/files/lib/lib/object/recordstreamer-h">RecordStreamer.h</a>"
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="#af63cc4141d5da9ef88eb0ec4b2b3c959">initializeRecordStreamer</a> (const Module &amp;M, function_ref&lt; void(RecordStreamer &amp;)&gt; Init)</td>
</tr>
...
<tr>
<td class="doxyMemberName">void initializeRecordStreamer (<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64promoteconstant-cpp/#a90f8350fecae261c25be85d38b451bff">const</a> <a href="/web-llvm/docs/api/classes/llvm/module">Module</a> &amp; M, <a href="/web-llvm/docs/api/classes/llvm/function-ref">function_ref</a>&lt; void(<a href="/web-llvm/docs/api/classes/llvm/recordstreamer">RecordStreamer</a> &amp;)&gt; Init)</td>
</tr>
</table>
</td>
...
<p>Definition at line 68 of file <a href="/web-llvm/docs/api/files/lib/lib/object/modulesymboltable-cpp">ModuleSymbolTable.cpp</a>.</p>


<p>References <a href="/web-llvm/docs/api/classes/llvm/inlineasm/#a2c0e1ae3b31928af2e0a390bbc2ea9b8ae46075a65afe271f3d7f91e1243aacca">llvm::InlineAsm::AD_ATT</a>, <a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/amdgpu/silowercontrolflow-cpp/#a4868c5d81c5ccc98c47aeab6244346a0">assert</a>, <a href="/web-llvm/docs/api/namespaces/llvm/#a9ee2a46a68a8aa54086f069cec64e4fa">llvm::createMCAsmParser</a>, <a href="/web-llvm/docs/api/classes/llvm/memorybuffer/#a0f68098734d6d3b451aacf5b38a67131">llvm::MemoryBuffer::getMemBuffer</a>, <a href="/web-llvm/docs/api/structs/llvm/targetregistry/#a85a69009ec328d5835241f56fb62cc6d">llvm::TargetRegistry::lookupTarget</a>, <a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/aarch64/aarch64advsimdscalarpass-cpp/#aacd2ab195054a3e6a74bfbb9d5d571c8">MRI</a>, <a href="/web-llvm/docs/api/classes/llvm/mccontext/#a68fb1a489deef96ac4b0d93d629e2ce1">llvm::MCContext::setDiagnosticHandler</a>, <a href="/web-llvm/docs/api/classes/llvm/mccontext/#a139a14c94184b5c989786a1666037955">llvm::MCContext::setObjectFileInfo</a>, <a href="/web-llvm/docs/api/namespaces/llvm/#a5f3f23062c5d5636bee27c54f4a407f0">llvm::SrcMgr</a> and <a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/mips/mips16isellowering-cpp/#a0acb682b8260ab1c60b918599864e2e5">T</a>.</p>


<p>Referenced by <a href="/web-llvm/docs/api/classes/llvm/modulesymboltable/#afeaa3f8d791f06d24dbe1ed910c27a9a">llvm::ModuleSymbolTable::CollectAsmSymbols</a> and <a href="/web-llvm/docs/api/classes/llvm/modulesymboltable/#a260eabd30cac206a16723c8cd6e0c5c4">llvm::ModuleSymbolTable::CollectAsmSymvers</a>.</p>
