...
<p>This file defines counterparts of C library allocation functions defined in the namespace 'std'.</p>


<p>The new allocation functions crash on allocation failure instead of returning null pointer.</p>
