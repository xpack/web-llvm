...
# `AMDGPUMacroFusion.cpp` File



## Included Headers

<div class="doxyIncludesList">#include "<a href="/web-llvm/docs/api/files/lib/lib/target/lib/target/amdgpu/amdgpumacrofusion-h">AMDGPUMacroFusion.h</a>"
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/namespaces/anonymous-amdgpumacrofusion-cpp-">anonymous{AMDGPUMacroFusion.cpp}</a></td>
</tr>
