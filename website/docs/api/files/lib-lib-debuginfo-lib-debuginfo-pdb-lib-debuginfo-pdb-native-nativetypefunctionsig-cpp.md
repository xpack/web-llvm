...
# `NativeTypeFunctionSig.cpp` File
...
<td class="doxyMemberIndexItemName" align="left" valign="top"><a href="/web-llvm/docs/api/namespaces/anonymous-nativetypefunctionsig-cpp-">anonymous{NativeTypeFunctionSig.cpp}</a></td>
</tr>
