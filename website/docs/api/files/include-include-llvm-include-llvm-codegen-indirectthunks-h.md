...
<p>Contains a base ThunkInserter class that simplifies injection of MI thunks as well as a default implementation of MachineFunctionPass wrapping several <span class="doxyComputerOutput">ThunkInserter</span>s for targets to extend.</p>
